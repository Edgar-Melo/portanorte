    ...
    <header class="bg-white border-b border-gray-200">
      <div class="container mx-auto px-6 py-4">
        <div class="flex items-center justify-between">
          <h1 class="text-2xl font-bold text-primary-800">Porta Norte - Porta-Pau-Mulato-Tradicional</h1>
          <button
          ...
          <div class="bg-white rounded-2xl p-8 shadow-2xl border border-gray-200">
            ...
            <div class="mb-6">
              <img
                ...
                alt="Porta-Pau-Mulato-Tradicional"
            ...
            <div class="space-y-4 mb-6">
              <div class="flex justify-between items-center">
                ...
                <span class="text-primary-800 font-semibold">Porta-Pau-Mulato-Tradicional</span>
              </div>
              <div class="flex justify-between items-center">
...
// Larguras disponíveis para a Porta-Pau-Mulato-Tradicional
