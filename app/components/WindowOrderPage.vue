    ...
    <header class="bg-white border-b border-gray-200">
      <div class="container mx-auto px-6 py-4">
        <div class="flex items-center justify-between">
          <h1 class="text-2xl font-bold text-primary-800">Porta Norte - Janelas</h1>
          <button
            @click="$router.push('/')"
      ...
      <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mb-12">
          <h2 class="text-4xl lg:text-5xl font-bold text-primary-800 mb-6">
            Encomende suas Janelas Personalizadas
          </h2>
          <p class="text-xl text-primary-700 max-w-3xl mx-auto leading-relaxed text-justify">
            Transforme sua ideia em realidade. Solicite uma cotação personalizada para janelas sob medida.
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div class="bg-white rounded-2xl p-8 shadow-2xl border border-gray-200">
            <h3 class="text-2xl font-bold text-primary-800 mb-6">Dados para Encomenda de Janelas</h3>
            ...
            <form @submit.prevent="submitOrder" class="space-y-6">
              ...
              <div>
                ...
                <div class="border-2 border-dashed border-primary-400 rounded-lg p-6 text-center hover:border-primary-500 transition duration-300">
                  ...
                  <div v-else class="relative">
                    ...
                    <button
                      @click="removeImage"
                      class="absolute top-2 right-2 bg-red-500 hover:bg-red-600 text-white rounded-full w-8 h-8 flex items-center justify-center transition duration-300"
                    >
                      ×
                    </button>
                    <p class="text-green-300 text-sm">Imagem carregada com sucesso!</p>
                  </div>
                </div>
              </div>
              ...
              >
                {{ isSubmitting ? 'Enviando...' : 'Enviar Encomenda de Janela' }}
              </button>
            </form>
          </div>
                ...
                <div class="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p class="text-primary-700">
                      A fabricação da sua janela leva em média <strong class="text-primary-800">25 a 30 dias</strong>
                ...
                <div class="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p class="text-primary-600 text-sm">
                      O restante (50%) será pago na entrega da janela.
                    </p>
                  </div>
                </div>
              </div>
...
import WindowCalculator from '~/components/WindowCalculator.vue'
...
const submitOrder = async () => {
  ...
  try {
    ...
    let message = `ENCOMENDA DE JANELA PERSONALIZADA:\n\n`
