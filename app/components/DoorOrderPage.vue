    ...
    <header class="bg-white border-b border-gray-200">
      <div class="container mx-auto px-6 py-4">
        <div class="flex items-center justify-between">
          <h1 class="text-2xl font-bold text-primary-800">Porta Norte - Portas</h1>
          <button
            @click="$router.push('/')"
      ...
      <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mb-12">
          <h2 class="text-4xl lg:text-5xl font-bold text-primary-800 mb-6">
            Encomende suas Portas Personalizadas
          </h2>
          <p class="text-xl text-primary-700 max-w-3xl mx-auto leading-relaxed text-justify">
            Transforme sua ideia em realidade. Solicite uma cotação personalizada para portas sob medida.
          </p>
        </div>
                ...
                <div class="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p class="text-primary-700">
                      A fabricação da sua porta leva em média <strong class="text-primary-800">20 a 25 dias</strong>
                ...
                <div class="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p class="text-primary-600 text-sm">
                      O restante (50%) será pago na entrega da porta.
                    </p>
                  </div>
                </div>
              </div>
...
const submitOrder = async () => {
  ...
  try {
    ...
    let message = `ENCOMENDA DE PORTA PERSONALIZADA:\n\n`
