    ...
    <header class="bg-white border-b border-gray-200">
      <div class="container mx-auto px-6 py-4">
        <div class="flex items-center justify-between">
          <h1 class="text-2xl font-bold text-primary-800">Porta Norte - Móveis para Sala</h1>
          <button
            @click="$router.push('/')"
      ...
      <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mb-12">
          <h2 class="text-4xl lg:text-5xl font-bold text-primary-800 mb-6">
            Encomende seus Móveis para Sala
          </h2>
          <p class="text-xl text-primary-700 max-w-3xl mx-auto leading-relaxed text-justify">
            Transforme sua ideia em realidade. Solicite uma cotação personalizada para móveis sob medida.
          </p>
        </div>
