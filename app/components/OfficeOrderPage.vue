      ...
      <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mb-12">
          <h2 class="text-4xl lg:text-5xl font-bold text-primary-800 mb-6">
            Encomende seus Móveis para Escritório
          </h2>
          <p class="text-xl text-primary-700 max-w-3xl mx-auto leading-relaxed text-justify">
            ...
            Solicite uma cotação personalizada para seu escritório.
          </p>
        </div>
                ...
                <div class="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p class="text-primary-700">
                      A fabricação do seu móvel leva em média <strong class="text-primary-800">12 a 18 dias</strong>
                ...
                <div class="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p class="text-primary-700 mb-2">
                      Entre em contato conosco para tirar suas dúvidas sobre móveis para escritório:
                    </p>
