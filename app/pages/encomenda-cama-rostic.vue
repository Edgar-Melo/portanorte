    ...
    <header class="bg-white border-b border-gray-200">
      <div class="container mx-auto px-6 py-4">
        <div class="flex items-center justify-between">
          <h1 class="text-2xl font-bold text-primary-800">Porta Norte - Cama-Rustic</h1>
    ...
    <div class="container mx-auto px-6 py-12">
      <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mb-12">
          <h2 class="text-4xl lg:text-5xl font-bold text-primary-800 mb-6">Cama-Rustic</h2>
          <p class="text-xl text-primary-700 max-w-3xl mx-auto leading-relaxed text-justify">
            Faça sua compra personalizada da Cama Rustic e receba no conforto da sua casa.
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div class="bg-white rounded-2xl p-8 shadow-2xl border border-gray-200">
            ...
            <!-- Imagem do Produto -->
            <div class="mb-6">
              <img src="/img/Cama-Rostic.png" alt="Cama-Rustic" class="w-full h-64 object-contain rounded-xl bg-gray-50">
            </div>
            ...
            <!-- Observações -->
            <div class="mb-6">
              <p class="text-primary-700 font-medium">Obs.: Cama-Rustic sem o Colchão</p>
            </div>
